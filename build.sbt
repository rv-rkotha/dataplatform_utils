...
libraryDependencies ++= Seq(
   ...
   */
  "org.joda" % "joda-convert" % "2.1.2" % "provided",
   ...
   */
  "com.amazonaws" % "aws-java-sdk-s3" % "1.11.199" % "provided",
  "com.amazonaws" % "aws-java-sdk-glue" % "1.11.199" % "provided",
  ...
  "software.amazon.awssdk" % "glue" % "2.5.29" % "provided",
  "software.amazon.awssdk" % "redshift" % "2.5.37" % "provided",
